...
function Body({
  ...
  return (
    <div
      ...
      className={clsx(
        "absolute left-0 right-0 z-[2] -translate-y-[150%] transition will-change-transform",
        ...
        <div className="flex flex-col gap-4 pb-8 pt-4">
          ...
          <Link
            className={clsx(
              ...
              "hover:scale-105 hover:rounded-2xl hover:bg-interface",
              "hover:rounded-2xl hover:bg-interface focus:scale-105",
              "active:scale-95",
              "w-fit px-4 py-2",
            )}
